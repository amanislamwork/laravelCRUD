<x-layout>
  <div class="container mx-auto mt-10">
    <div>
      ...
      @endif
      <form method="POST" action="{{ route('product.store') }}" class="mt-10 max-w-3xl rounded-xl bg-white p-8 ">
        @csrf
        @method('POST')
        <div class="border-b border-gray-900/10 pb-12">
          ...
          <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            ...
            <div class="sm:col-span-12">
              ...
              <div class="mt-2">
                <input type="text" name="qty" id="qty" autocomplete="Quantity"
                  class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6">
              </div>
            </div>
            ...
            <div class="sm:col-span-12">
              ...
              <div class="mt-2">
                <input id="text" name="price" type="text" autocomplete="price"
                  class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6">
              </div>
            </div>
            ...
            <div class="sm:col-span-12">
              ...
              <div class="mt-2">
                <input type="text" name="bio" id="bio" autocomplete="bio"
                  class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6">
              </div>
            </div>
